      ...
      <div className="fixed top-0 left-0 w-full z-[999] pointer-events-none px-4 md:px-6 pt-4 md:pt-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center relative">
          ...
          <div className="pointer-events-auto">
            <Link to="/" onClick={handleScrollTop} className="flex items-center gap-2 md:gap-3 group">
              <img 
                src="/logo.svg" 
                alt="Logo" 
          ...
          <div className="pointer-events-auto flex items-center gap-2 md:gap-3">
            <a href="https://github.com/prashantmore45" target="_blank" rel="noreferrer" className="hidden sm:flex p-2 md:p-3 bg-black/40 backdrop-blur-md border border-white/10 rounded-full text-gray-400 hover:text-white hover:border-primary/50 transition-all hover:scale-110">
                <FaGithub size={20} />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hidden sm:flex p-2 md:p-3 bg-black/40 backdrop-blur-md border border-white/10 rounded-full text-gray-400 hover:text-white hover:border-blue-500/50 transition-all hover:scale-110">
                <FaLinkedin size={20} />
            </a>
            <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 md:px-5 md:py-2.5 bg-primary/90 hover:bg-primary backdrop-blur-md border border-white/10 rounded-full text-white font-medium transition-all hover:scale-105 shadow-[0_0_15px_rgba(139,92,246,0.5)] text-sm md:text-base">
